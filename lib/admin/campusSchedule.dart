                ...
                if (snapshot.hasData) {
                  ...
                  for (int i = 0; i < snapshot.data!.docs.length; i++) {
                    if (snapshot.data!.docs[i]['role'] == "student" &&
                        snapshot.data!.docs[i]['location'].length >
                            0) if (snapshot.data!.docs[i]['location'][0]
                                .toUpperCase() +
                      ...
                      for (int j = 0; j < 5; j++) {
                        ...
                        if (snapshot.data!.docs[i]['schedule'][j.toString()] !=
                            null) {
                          for (int k = 0;
                              k <
                                  snapshot.data!
                                      .docs[i]['schedule'][j.toString()].length;
                              k += 2) {
                            if ((snapshot.data!.docs[i]['schedule']
                                            [j.toString()][k + 1] ==
                                        "Possible Worktime" ||
                                    snapshot.data!.docs[i]['schedule']
                                            [j.toString()][k + 1] ==
                                        "Added Worktime") &&
                                snapshot.data!.docs[i]['schedule'][j.toString()]
                                        [k + 2] !=
                                    1.toString()) {
                              if (locationShifts[j.toString()] == null) {
                                locationShifts[j.toString()] = [
